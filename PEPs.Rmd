...
```{r}
megnorm <- read.delim("C:/Users/afsab/Dropbox/Academia/Computing/R/Morfometria/jan2021-PEPs/input-para-sumarizacoes/meg.txt")
milnorm <- read.delim("C:/Users/afsab/Dropbox/Academia/Computing/R/Morfometria/jan2021-PEPs/input-para-sumarizacoes/mil.txt")
saxnorm <- read.delim("C:/Users/afsab/Dropbox/Academia/Computing/R/Morfometria/jan2021-PEPs/input-para-sumarizacoes/sax.txt")
taonorm <- read.delim("C:/Users/afsab/Dropbox/Academia/Computing/R/Morfometria/jan2021-PEPs/input-para-sumarizacoes/tao.txt")
petnorm <- read.delim("C:/Users/afsab/Dropbox/Academia/Computing/R/Morfometria/jan2021-PEPs/input-para-sumarizacoes/pet.txt")
...
peps <- 
  read.delim("C:/Users/afsab/Dropbox/Academia/Computing/R/Morfometria/jan2021-PEPs/thoropa380_spp_peps.txt")
...
pepsparcial <- 
  read.delim("C:/Users/afsab/Dropbox/Academia/Computing/R/Morfometria/jan2021-PEPs/thoropa502_spp_pepsparcial.txt")
...
```{r}
#MPA-II by species
nexcesqspp <- read.delim("C:/Users/afsab/Dropbox/Academia/Computing/R/Morfometria/jan2021-PEPs/grmil216_spp_nexcesq.txt")
...
#IMT-II by species
ntubesqspp <- read.delim("C:/Users/afsab/Dropbox/Academia/Computing/R/Morfometria/jan2021-PEPs/grmil531_spp_ntubesq.txt")
...
niiesqspp <- read.delim("C:/Users/afsab/Dropbox/Academia/Computing/R/Morfometria/jan2021-PEPs/grmil532_spp_niiesq.txt")
...
niiiesqspp <- read.delim("C:/Users/afsab/Dropbox/Academia/Computing/R/Morfometria/jan2021-PEPs/grmil600_spp_niiiesq.txt")
...
nivesqspp <- read.delim("C:/Users/afsab/Dropbox/Academia/Computing/R/Morfometria/jan2021-PEPs/grmil616_spp_nivesq.txt")
...
```{r}
cor <- read.delim("C:/Users/afsab/Dropbox/Academia/Computing/R/Morfometria/jan2021-PEPs/anocor_623.txt")

ggplot(data = cor) + 
  geom_bar(mapping = aes(x = ano, fill = corexcesq)) +
  facet_wrap(~ spp)

mescor <- read.delim("C:/Users/afsab/Dropbox/Academia/Computing/R/Morfometria/jan2021-PEPs/mescor_607.txt")
